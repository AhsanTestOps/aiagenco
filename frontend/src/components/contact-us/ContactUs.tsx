          ...
          <div className="flex-[1.5]">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="pt-6">
                <button
                  type="submit"
                  className="bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-bold px-10 py-4 rounded-full transition-all duration-300 shadow-lg shadow-purple-500/20 active:scale-95"
                >
